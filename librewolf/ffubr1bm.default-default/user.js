...
user_pref("general.smoothScroll.msdPhysics.regularSpringConstant",       550);//NSS   [1000]
user_pref("general.smoothScroll.msdPhysics.slowdownMinDeltaMS",           15);//NSS     [12]
user_pref("general.smoothScroll.msdPhysics.slowdownMinDeltaRatio",     "2.0");//NSS    [1.3]
user_pref("general.smoothScroll.msdPhysics.slowdownSpringConstant",      1050);//NSS   [2000]
user_pref("general.smoothScroll.currentVelocityWeighting",             "0.50");//NSS ["0.25"]
...
user_pref("mousewheel.default.delta_multiplier_x",                       30);//NSS    [100]
user_pref("mousewheel.default.delta_multiplier_y",                       30);//NSS    [100]
user_pref("mousewheel.default.delta_multiplier_z",                       30);//NSS    [100]
...
user_pref("mousewheel.acceleration.factor",                               70);//NSS     [10]
